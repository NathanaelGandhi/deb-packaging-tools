...
def _parse_args(argv=None) -> argparse.Namespace:
    ...
    parser.add_argument("--no-clean", action="store_true", help="do not run dh_clean")
    parser.add_argument(
        "--no-lintian",
        action="store_true",
...
def _build_source_deb(args: argparse.Namespace):
    check_and_install_dpkg_deps(["debuild"])
    # Base command
    cmd = ["debuild"]
